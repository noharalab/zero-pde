...
dt=2*3.1415/float(n);
  for (int i=0; i<n; i++) {
    ...
    P3.x=cos(dti)*0.6; P3.y=sin(dti)*0.6; P3.z=1;
    P4.x=cos(dtip1)*0.6; P4.y=sin(dtip1)*0.6; P4.z=1;
    P5.x=0; P5.y=0; P5.z=1;
    P6.x=0; P6.y=0; P6.z=0;
draw_triangle(P1,P2,P6);
draw_triangle(P3,P4,P5);
draw_quad(P1,P3,P5,P6);
draw_quad(P1,P2,P4,P3);
draw_quad(P2,P4,P5,P6);
}
